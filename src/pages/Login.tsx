  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-sm border border-gray-100">
        <h1 className="text-2xl font-semibold text-center text-gray-900 mb-6">Sales Reimbursement System</h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-[#0095D5] text-white rounded py-2 px-4 text-sm font-medium hover:bg-[#007BAF] transition-colors shadow-sm"
          >
            Log in
          </button>
        </form>
